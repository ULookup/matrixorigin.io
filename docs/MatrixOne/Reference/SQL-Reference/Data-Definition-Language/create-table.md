...
differs_from_mysql:
  ...
  - "Spatial type names (GEOMETRY, POINT, etc.) are syntactically accepted but non-functional; SET type is not supported; MEDIUMINT is syntactically accepted but treated as INT"
