...
Use `validator-ignore-exec` when a SQL example is **syntactically valid** MatrixOne SQL
but cannot reliably run in the generic execution test environment. Typical cases:
